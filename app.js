...
const allQuestions = [
    ...
    },
    {
        ...
        correctIndex: 0,
        explanation: 'החובזה היא מהצמחים הנפוצים ביותר לליקוט בישראל. העלים נאכלים חיים או מבושלים ויש להם טעם עדין.',
    ...
    },
    {
        ...
        options: ['תיון דביק', 'קורנית', 'עולש', 'סרפד'],
        correctIndex: 0,
        explanation: 'התיון הדביק הוא צמח רב-שנתי בעל ריח חזק ועלים דביקים. משמש ברפואה עממית לטיפול במגוון בעיות.',
    ...
    },
    {
        ...
        options: ['כליל החורש', 'תיון דביק', 'קורנית', 'אשחר'],
        correctIndex: 3,
